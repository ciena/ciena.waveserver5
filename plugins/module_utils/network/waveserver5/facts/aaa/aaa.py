...
"""
The waveserver5 aaa fact class
...
from ansible_collections.ciena.waveserver5.plugins.module_utils.network.waveserver5.argspec.aaa.aaa import (
    AaaArgs,
)
...
class AaaFacts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        if not data:
            config_filter = """
                <waveserver-aaa xmlns="urn:ciena:params:xml:ns:yang:ciena-ws:ciena-waveserver-aaa">
                </waveserver-aaa>
                """
        ...
        resource = data.xpath("/rpc-reply/data/waveserver-aaa")[0]
