.. _ciena.waveserver5.waveserver5_facts_module:
...
**Get facts about waveserver5 devices.**
...
Synopsis
--------
- Collects facts from network devices running the waveserver5 operating system. This module places the facts gathered in the fact tree keyed by the respective resource name.  The facts module will always collect a base set of facts from the device and can enable or disable collection of additional facts.
